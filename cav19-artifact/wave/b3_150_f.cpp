...
s.add_edge("Node1", "down", "up", "x1>=50 && x1<=400", "", "", 
                    [](syntax::layout_t const & l){
                       wave::layout_t const & _l = CAST(wave::layout_t const &, l);
                       return _l.out6 < 2 && _l.out7 < 2 && _l.out8 < 2 && _l.out9 < 2 && _l.out10 < 2 && _l.out11 < 2 && _l.out12 < 2 && _l.out13 < 2 && _l.out14 < 2 && _l.out15 < 2 && (_l.out6+(_l.out7+(_l.out8+(_l.out9+(_l.out10+(_l.out11+(_l.out12+(_l.out13+(_l.out14+(_l.out15)))))))))) >= 10;
                    }
                    , 
                    [](syntax::layout_t  & l){
                       wave::layout_t & _l = CAST(wave::layout_t &, l);
...
s.add_edge("Node2", "down", "up", "x2>=200 && x2<=600", "", "", 
                    [](syntax::layout_t const & l){
                       wave::layout_t const & _l = CAST(wave::layout_t const &, l);
                       return _l.out16 < 2 && _l.out17 < 2 && _l.out18 < 2 && _l.out19 < 2 && (_l.out16+(_l.out17+(_l.out18+(_l.out19)))) >= 4;
                    }
                    , 
                    [](syntax::layout_t  & l){
                       wave::layout_t & _l = CAST(wave::layout_t &, l);
...
s.add_edge("Node2", "down", "down", "x2 == 200", "x2", "", 
                    [](syntax::layout_t const & l){
                       wave::layout_t const & _l = CAST(wave::layout_t const &, l);
                       return (_l.out16 != 2 && (_l.out17 != 2 && (_l.out18 != 2 && (_l.out19 != 2)))) == 0;
                    }
                    );
