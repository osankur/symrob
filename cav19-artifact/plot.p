...
"< sort -n output/multi_tchecker -k2 -t ';'" using ($2) title 'Abs-enumerative' with linespoints ls 2,\
...
"< sort -n output/mono_tchecker -k2 -t ';'" using ($2) title 'Abs-enumerative' with linespoints ls 2,\
...
"< sort -n output/wave_tchecker -k2 -t ';'" using ($2) title 'Abs-enumerative' with linespoints lt 2,\
