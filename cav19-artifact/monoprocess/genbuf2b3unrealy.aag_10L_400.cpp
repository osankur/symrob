...
s.add_location("Circuit", "UpdatedLreg_controllable_BtoS_ACK1_out", "", "", syntax::loc_t::URGENT);
s.add_edge("Circuit", "UpdatedLreg_nstateG7_1_out", "UpdatedLreg_controllable_BtoS_ACK1_out", "", "", "", 
        [](syntax::layout_t const & l){\
        monoprocess::layout_t const & _l = CAST(monoprocess::layout_t const &, l);\
        return _l.Lreg_controllable_BtoS_ACK1_out==(_l.Icontrollable_BtoS_ACK1);;\
        }
        );
s.add_edge("Circuit", "UpdatedLreg_nstateG7_1_out", "UpdatedLreg_controllable_BtoS_ACK1_out", "x_46 <= 500", "", "", 
        [](syntax::layout_t const & l){\
        monoprocess::layout_t const & _l = CAST(monoprocess::layout_t const &, l);\
        return _l.Lreg_controllable_BtoS_ACK1_out == 1 && _l.Lreg_controllable_BtoS_ACK1_out != (_l.Icontrollable_BtoS_ACK1);\
        }
        );
s.add_edge("Circuit", "UpdatedLreg_nstateG7_1_out", "UpdatedLreg_controllable_BtoS_ACK1_out", "x_46 <= 2000", "", "", 
        [](syntax::layout_t const & l){\
        monoprocess::layout_t const & _l = CAST(monoprocess::layout_t const &, l);\
        return _l.Lreg_controllable_BtoS_ACK1_out == 0 && _l.Lreg_controllable_BtoS_ACK1_out != (_l.Icontrollable_BtoS_ACK1);\
        }
        );
s.add_location("Circuit", "UpdatedLreg_controllable_BtoS_ACK1_out_becomes0","x_46<=500", "");
s.add_location("Circuit", "UpdatedLreg_controllable_BtoS_ACK1_out_becomes1","x_46<=2000", "");
s.add_edge("Circuit", "UpdatedLreg_nstateG7_1_out", "UpdatedLreg_controllable_BtoS_ACK1_out_becomes0", "x_46 < 500", "", "", 
        [](syntax::layout_t const & l){\
        monoprocess::layout_t const & _l = CAST(monoprocess::layout_t const &, l);\
        return _l.Lreg_controllable_BtoS_ACK1_out == 1 && _l.Lreg_controllable_BtoS_ACK1_out != (_l.Icontrollable_BtoS_ACK1);\
        }
        );
s.add_edge("Circuit", "UpdatedLreg_controllable_BtoS_ACK1_out_becomes0", "UpdatedLreg_controllable_BtoS_ACK1_out", "x_46 >= 500", "x_46", "", syntax::layout_true,  [](syntax::layout_t  & l){\
                       monoprocess::layout_t & _l = CAST(monoprocess::layout_t &, l);\
                       _l.Lreg_controllable_BtoS_ACK1_out = (_l.Icontrollable_BtoS_ACK1);;\
                    }
                    );
s.add_edge("Circuit", "UpdatedLreg_nstateG7_1_out", "UpdatedLreg_controllable_BtoS_ACK1_out_becomes1", "x_46 < 2000", "", "", 
        [](syntax::layout_t const & l){\
        monoprocess::layout_t const & _l = CAST(monoprocess::layout_t const &, l);\
        return _l.Lreg_controllable_BtoS_ACK1_out == 0 && _l.Lreg_controllable_BtoS_ACK1_out != (_l.Icontrollable_BtoS_ACK1);\
        }
        );
s.add_edge("Circuit", "UpdatedLreg_controllable_BtoS_ACK1_out_becomes1", "UpdatedLreg_controllable_BtoS_ACK1_out", "x_46 >= 2000", "x_46", "", syntax::layout_true,  [](syntax::layout_t  & l){\
                       monoprocess::layout_t & _l = CAST(monoprocess::layout_t &, l);\
                       _l.Lreg_controllable_BtoS_ACK1_out = (_l.Icontrollable_BtoS_ACK1);;\
                    }
                    );
s.add_edge("Circuit", "UpdatedLreg_controllable_BtoS_ACK1_out", "dead", "T>4000", "", "", syntax::layout_true);
s.add_edge("Circuit", "UpdatedLreg_controllable_BtoS_ACK1_out", "init", "T<=4000", "T", "", syntax::layout_true);
