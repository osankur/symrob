...
s.add_edge("Circuit", "UpdatedLreg_controllable_hgrant3_out", "dead", "T>3000", "", "", syntax::layout_true);
s.add_edge("Circuit", "UpdatedLreg_controllable_hgrant3_out", "init", "T<=3000", "T", "", syntax::layout_true);
