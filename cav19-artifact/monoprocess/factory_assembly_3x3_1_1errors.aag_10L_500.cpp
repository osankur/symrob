...
s.add_location("Circuit", "UpdatedLprev_p2_2", "", "", syntax::loc_t::URGENT);
s.add_edge("Circuit", "UpdatedLprev_p2_1", "UpdatedLprev_p2_2", "", "", "", 
        [](syntax::layout_t const & l){\
        monoprocess::layout_t const & _l = CAST(monoprocess::layout_t const &, l);\
        return _l.Lprev_p2_2==(_l.Ip2_2);;\
        }
        );
s.add_edge("Circuit", "UpdatedLprev_p2_1", "UpdatedLprev_p2_2", "x_56 <= 500", "", "", 
        [](syntax::layout_t const & l){\
        monoprocess::layout_t const & _l = CAST(monoprocess::layout_t const &, l);\
        return _l.Lprev_p2_2 == 1 && _l.Lprev_p2_2 != (_l.Ip2_2);\
        }
        );
s.add_edge("Circuit", "UpdatedLprev_p2_1", "UpdatedLprev_p2_2", "x_56 <= 2000", "", "", 
        [](syntax::layout_t const & l){\
        monoprocess::layout_t const & _l = CAST(monoprocess::layout_t const &, l);\
        return _l.Lprev_p2_2 == 0 && _l.Lprev_p2_2 != (_l.Ip2_2);\
        }
        );
s.add_location("Circuit", "UpdatedLprev_p2_2_becomes0","x_56<=500", "");
s.add_location("Circuit", "UpdatedLprev_p2_2_becomes1","x_56<=2000", "");
s.add_edge("Circuit", "UpdatedLprev_p2_1", "UpdatedLprev_p2_2_becomes0", "x_56 < 500", "", "", 
        [](syntax::layout_t const & l){\
        monoprocess::layout_t const & _l = CAST(monoprocess::layout_t const &, l);\
        return _l.Lprev_p2_2 == 1 && _l.Lprev_p2_2 != (_l.Ip2_2);\
        }
        );
s.add_edge("Circuit", "UpdatedLprev_p2_2_becomes0", "UpdatedLprev_p2_2", "x_56 >= 500", "x_56", "", syntax::layout_true,  [](syntax::layout_t  & l){\
                       monoprocess::layout_t & _l = CAST(monoprocess::layout_t &, l);\
                       _l.Lprev_p2_2 = (_l.Ip2_2);;\
                    }
                    );
s.add_edge("Circuit", "UpdatedLprev_p2_1", "UpdatedLprev_p2_2_becomes1", "x_56 < 2000", "", "", 
        [](syntax::layout_t const & l){\
        monoprocess::layout_t const & _l = CAST(monoprocess::layout_t const &, l);\
        return _l.Lprev_p2_2 == 0 && _l.Lprev_p2_2 != (_l.Ip2_2);\
        }
        );
s.add_edge("Circuit", "UpdatedLprev_p2_2_becomes1", "UpdatedLprev_p2_2", "x_56 >= 2000", "x_56", "", syntax::layout_true,  [](syntax::layout_t  & l){\
                       monoprocess::layout_t & _l = CAST(monoprocess::layout_t &, l);\
                       _l.Lprev_p2_2 = (_l.Ip2_2);;\
                    }
                    );
s.add_edge("Circuit", "UpdatedLprev_p2_2", "dead", "T>5000", "", "", syntax::layout_true);
s.add_edge("Circuit", "UpdatedLprev_p2_2", "init", "T<=5000", "T", "", syntax::layout_true);
