...
s.add_edge("Circuit", "UpdatedLreg_controllable_BtoS_ACK0_out", "dead", "T>3000", "", "", syntax::layout_true);
s.add_edge("Circuit", "UpdatedLreg_controllable_BtoS_ACK0_out", "init", "T<=3000", "T", "", syntax::layout_true);
