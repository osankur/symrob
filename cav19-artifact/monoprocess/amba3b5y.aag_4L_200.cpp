...
s.add_edge("Circuit", "UpdatedLsys_fair0done_out", "dead", "T>2000", "", "", syntax::layout_true);
s.add_edge("Circuit", "UpdatedLsys_fair0done_out", "init", "T<=2000", "T", "", syntax::layout_true);
