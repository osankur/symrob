...
bool IP2sh1;
bool IP2sh2;
bool IP2controllable_do_shift;
bool LP2state_benchn11;
bool LP2state_benchr0_out;
bool LP2state_benchr1_out;
bool LP2state_benchr2_out;
bool LP2state_benchr3_out;
bool LP2state_benchr4_out;
bool LP2state_benchr5_out;
bool LP2state_benchr6_out;
bool LP2state_benchr7_out;
...
IP2sh1 =0;
IP2sh2 =0;
IP2controllable_do_shift =0;
LP2state_benchn11 =0;
LP2state_benchr0_out =0;
LP2state_benchr1_out =0;
LP2state_benchr2_out =0;
LP2state_benchr3_out =0;
LP2state_benchr4_out =0;
LP2state_benchr5_out =0;
LP2state_benchr6_out =0;
LP2state_benchr7_out =0;
...
if (_l.IP2sh0 != IP2sh0) return false;
if (_l.IP2sh1 != IP2sh1) return false;
if (_l.IP2sh2 != IP2sh2) return false;
if (_l.IP2controllable_do_shift != IP2controllable_do_shift) return false;
if (_l.LP2state_benchn11 != LP2state_benchn11) return false;
if (_l.LP2state_benchr0_out != LP2state_benchr0_out) return false;
if (_l.LP2state_benchr1_out != LP2state_benchr1_out) return false;
if (_l.LP2state_benchr2_out != LP2state_benchr2_out) return false;
if (_l.LP2state_benchr3_out != LP2state_benchr3_out) return false;
if (_l.LP2state_benchr4_out != LP2state_benchr4_out) return false;
if (_l.LP2state_benchr5_out != LP2state_benchr5_out) return false;
if (_l.LP2state_benchr6_out != LP2state_benchr6_out) return false;
if (_l.LP2state_benchr7_out != LP2state_benchr7_out) return false;
...
return true;
	...
	boost::hash_combine(seed,IP2sh0);
	boost::hash_combine(seed,IP2sh1);
	boost::hash_combine(seed,IP2sh2);
	boost::hash_combine(seed,IP2controllable_do_shift);
	boost::hash_combine(seed,LP2state_benchn11);
	boost::hash_combine(seed,LP2state_benchr0_out);
	boost::hash_combine(seed,LP2state_benchr1_out);
	boost::hash_combine(seed,LP2state_benchr2_out);
	boost::hash_combine(seed,LP2state_benchr3_out);
	boost::hash_combine(seed,LP2state_benchr4_out);
	boost::hash_combine(seed,LP2state_benchr5_out);
	boost::hash_combine(seed,LP2state_benchr6_out);
	boost::hash_combine(seed,LP2state_benchr7_out);
...
s.add_location("Process2", "JustSetIP2sh0", "", "", syntax::loc_t::COMMITTED);
s.add_edge("Process2", "up", "JustSetIP2sh0", "", "", "", syntax::layout_true,  [](syntax::layout_t  & l){\
    multi::layout_t & _l = CAST(multi::layout_t &, l);\
    _l.IP2sh0 = 0;;\
    }
    );
...
s.add_location("Process2", "JustSetIP2sh1", "", "", syntax::loc_t::COMMITTED);
s.add_edge("Process2", "JustSetIP2sh0", "JustSetIP2sh1", "", "", "", syntax::layout_true,  [](syntax::layout_t  & l){\
    multi::layout_t & _l = CAST(multi::layout_t &, l);\
    _l.IP2sh1 = 0;;\
    }
    );
...
s.add_location("Process2", "JustSetIP2sh2", "", "", syntax::loc_t::COMMITTED);
s.add_edge("Process2", "JustSetIP2sh1", "JustSetIP2sh2", "", "", "", syntax::layout_true,  [](syntax::layout_t  & l){\
    multi::layout_t & _l = CAST(multi::layout_t &, l);\
    _l.IP2sh2 = 0;;\
    }
    );
...
s.add_location("Process2", "JustSetIP2controllable_do_shift", "", "", syntax::loc_t::COMMITTED);
s.add_edge("Process2", "JustSetIP2sh2", "JustSetIP2controllable_do_shift", "", "", "", syntax::layout_true,  [](syntax::layout_t  & l){\
    multi::layout_t & _l = CAST(multi::layout_t &, l);\
    _l.IP2controllable_do_shift = 0;;\
    }
    );
s.add_edge("Process2", "JustSetIP2sh2", "JustSetIP2controllable_do_shift", "", "", "", syntax::layout_true,  [](syntax::layout_t  & l){\
    multi::layout_t & _l = CAST(multi::layout_t &, l);\
    _l.IP2controllable_do_shift = 1;;\
    }
    );
s.add_location("Process2", "UpdatedLP2state_benchn11", "", "", syntax::loc_t::COMMITTED);
s.add_edge("Process2", "JustSetIP2controllable_do_shift", "UpdatedLP2state_benchn11", "", "", "", syntax::layout_true,  [](syntax::layout_t  & l){\
    multi::layout_t & _l = CAST(multi::layout_t &, l);\
    _l.LP2state_benchn11 = 1;;\
    }
    );
s.add_location("Process2", "UpdatedLP2state_benchr0_out", "", "", syntax::loc_t::COMMITTED);
s.add_edge("Process2", "UpdatedLP2state_benchn11", "UpdatedLP2state_benchr0_out", "", "", "", syntax::layout_true,  [](syntax::layout_t  & l){\
    multi::layout_t & _l = CAST(multi::layout_t &, l);\
    _l.LP2state_benchr0_out = (1-((1-((1-((1-(_l.LP2state_benchr0_out)) * (_l.LP2state_benchn11))) * (1-(_l.IP2controllable_do_shift)))) * (1-((1-((1-((1-((1-((1-((1-(_l.LP2state_benchr0_out)) * (_l.LP2state_benchn11))) * (1-(_l.IP2sh0)))) * (1-(((_l.LP2state_benchr7_out) * (_l.LP2state_benchn11)) * (_l.IP2sh0))))) * (1-(_l.IP2sh2)))) * (1-((1-((1-(((_l.LP2state_benchr4_out) * (_l.LP2state_benchn11)) * (1-(_l.IP2sh0)))) * (1-(((_l.LP2state_benchr3_out) * (_l.LP2state_benchn11)) * (_l.IP2sh0))))) * (_l.IP2sh2))))) * (_l.IP2controllable_do_shift)))));;\
    }
    );
s.add_location("Process2", "UpdatedLP2state_benchr1_out", "", "", syntax::loc_t::COMMITTED);
s.add_edge("Process2", "UpdatedLP2state_benchr0_out", "UpdatedLP2state_benchr1_out", "", "", "", syntax::layout_true,  [](syntax::layout_t  & l){\
    multi::layout_t & _l = CAST(multi::layout_t &, l);\
    _l.LP2state_benchr1_out = (1-((1-(((_l.LP2state_benchr1_out) * (_l.LP2state_benchn11)) * (1-(_l.IP2controllable_do_shift)))) * (1-((1-((1-((1-((1-(((_l.LP2state_benchr1_out) * (_l.LP2state_benchn11)) * (1-(_l.IP2sh0)))) * (1-((1-((1-(_l.LP2state_benchr0_out)) * (_l.LP2state_benchn11))) * (_l.IP2sh0))))) * (1-(_l.IP2sh2)))) * (1-((1-((1-(((_l.LP2state_benchr5_out) * (_l.LP2state_benchn11)) * (1-(_l.IP2sh0)))) * (1-(((_l.LP2state_benchr4_out) * (_l.LP2state_benchn11)) * (_l.IP2sh0))))) * (_l.IP2sh2))))) * (_l.IP2controllable_do_shift)))));;\
    }
    );
s.add_location("Process2", "UpdatedLP2state_benchr2_out", "", "", syntax::loc_t::COMMITTED);
s.add_edge("Process2", "UpdatedLP2state_benchr1_out", "UpdatedLP2state_benchr2_out", "", "", "", syntax::layout_true,  [](syntax::layout_t  & l){\
    multi::layout_t & _l = CAST(multi::layout_t &, l);\
    _l.LP2state_benchr2_out = (1-((1-(((_l.LP2state_benchr2_out) * (_l.LP2state_benchn11)) * (1-(_l.IP2controllable_do_shift)))) * (1-((1-((1-((1-((1-(((_l.LP2state_benchr2_out) * (_l.LP2state_benchn11)) * (1-(_l.IP2sh0)))) * (1-(((_l.LP2state_benchr1_out) * (_l.LP2state_benchn11)) * (_l.IP2sh0))))) * (1-(_l.IP2sh2)))) * (1-((1-((1-(((_l.LP2state_benchr6_out) * (_l.LP2state_benchn11)) * (1-(_l.IP2sh0)))) * (1-(((_l.LP2state_benchr5_out) * (_l.LP2state_benchn11)) * (_l.IP2sh0))))) * (_l.IP2sh2))))) * (_l.IP2controllable_do_shift)))));;\
    }
    );
s.add_location("Process2", "UpdatedLP2state_benchr3_out", "", "", syntax::loc_t::COMMITTED);
s.add_edge("Process2", "UpdatedLP2state_benchr2_out", "UpdatedLP2state_benchr3_out", "", "", "", syntax::layout_true,  [](syntax::layout_t  & l){\
    multi::layout_t & _l = CAST(multi::layout_t &, l);\
    _l.LP2state_benchr3_out = (1-((1-(((_l.LP2state_benchr3_out) * (_l.LP2state_benchn11)) * (1-(_l.IP2controllable_do_shift)))) * (1-((1-((1-((1-((1-(((_l.LP2state_benchr3_out) * (_l.LP2state_benchn11)) * (1-(_l.IP2sh0)))) * (1-(((_l.LP2state_benchr2_out) * (_l.LP2state_benchn11)) * (_l.IP2sh0))))) * (1-(_l.IP2sh2)))) * (1-((1-((1-(((_l.LP2state_benchr7_out) * (_l.LP2state_benchn11)) * (1-(_l.IP2sh0)))) * (1-(((_l.LP2state_benchr6_out) * (_l.LP2state_benchn11)) * (_l.IP2sh0))))) * (_l.IP2sh2))))) * (_l.IP2controllable_do_shift)))));;\
    }
    );
s.add_location("Process2", "UpdatedLP2state_benchr4_out", "", "", syntax::loc_t::COMMITTED);
s.add_edge("Process2", "UpdatedLP2state_benchr3_out", "UpdatedLP2state_benchr4_out", "", "", "", syntax::layout_true,  [](syntax::layout_t  & l){\
    multi::layout_t & _l = CAST(multi::layout_t &, l);\
    _l.LP2state_benchr4_out = (1-((1-(((_l.LP2state_benchr4_out) * (_l.LP2state_benchn11)) * (1-(_l.IP2controllable_do_shift)))) * (1-((1-((1-((1-((1-(((_l.LP2state_benchr4_out) * (_l.LP2state_benchn11)) * (1-(_l.IP2sh0)))) * (1-(((_l.LP2state_benchr3_out) * (_l.LP2state_benchn11)) * (_l.IP2sh0))))) * (1-(_l.IP2sh2)))) * (1-((1-((1-((1-((1-(_l.LP2state_benchr0_out)) * (_l.LP2state_benchn11))) * (1-(_l.IP2sh0)))) * (1-(((_l.LP2state_benchr7_out) * (_l.LP2state_benchn11)) * (_l.IP2sh0))))) * (_l.IP2sh2))))) * (_l.IP2controllable_do_shift)))));;\
    }
    );
s.add_location("Process2", "UpdatedLP2state_benchr5_out", "", "", syntax::loc_t::COMMITTED);
s.add_edge("Process2", "UpdatedLP2state_benchr4_out", "UpdatedLP2state_benchr5_out", "", "", "", syntax::layout_true,  [](syntax::layout_t  & l){\
    multi::layout_t & _l = CAST(multi::layout_t &, l);\
    _l.LP2state_benchr5_out = (1-((1-(((_l.LP2state_benchr5_out) * (_l.LP2state_benchn11)) * (1-(_l.IP2controllable_do_shift)))) * (1-((1-((1-((1-((1-(((_l.LP2state_benchr5_out) * (_l.LP2state_benchn11)) * (1-(_l.IP2sh0)))) * (1-(((_l.LP2state_benchr4_out) * (_l.LP2state_benchn11)) * (_l.IP2sh0))))) * (1-(_l.IP2sh2)))) * (1-((1-((1-(((_l.LP2state_benchr1_out) * (_l.LP2state_benchn11)) * (1-(_l.IP2sh0)))) * (1-((1-((1-(_l.LP2state_benchr0_out)) * (_l.LP2state_benchn11))) * (_l.IP2sh0))))) * (_l.IP2sh2))))) * (_l.IP2controllable_do_shift)))));;\
    }
    );
s.add_location("Process2", "UpdatedLP2state_benchr6_out", "", "", syntax::loc_t::COMMITTED);
s.add_edge("Process2", "UpdatedLP2state_benchr5_out", "UpdatedLP2state_benchr6_out", "", "", "", syntax::layout_true,  [](syntax::layout_t  & l){\
    multi::layout_t & _l = CAST(multi::layout_t &, l);\
    _l.LP2state_benchr6_out = (1-((1-(((_l.LP2state_benchr6_out) * (_l.LP2state_benchn11)) * (1-(_l.IP2controllable_do_shift)))) * (1-((1-((1-((1-((1-(((_l.LP2state_benchr6_out) * (_l.LP2state_benchn11)) * (1-(_l.IP2sh0)))) * (1-(((_l.LP2state_benchr5_out) * (_l.LP2state_benchn11)) * (_l.IP2sh0))))) * (1-(_l.IP2sh2)))) * (1-((1-((1-(((_l.LP2state_benchr2_out) * (_l.LP2state_benchn11)) * (1-(_l.IP2sh0)))) * (1-(((_l.LP2state_benchr1_out) * (_l.LP2state_benchn11)) * (_l.IP2sh0))))) * (_l.IP2sh2))))) * (_l.IP2controllable_do_shift)))));;\
    }
    );
s.add_location("Process2", "UpdatedLP2state_benchr7_out", "", "", syntax::loc_t::COMMITTED);
s.add_edge("Process2", "UpdatedLP2state_benchr6_out", "UpdatedLP2state_benchr7_out", "", "", "", syntax::layout_true,  [](syntax::layout_t  & l){\
    multi::layout_t & _l = CAST(multi::layout_t &, l);\
    _l.LP2state_benchr7_out = (1-((1-(((_l.LP2state_benchr7_out) * (_l.LP2state_benchn11)) * (1-(_l.IP2controllable_do_shift)))) * (1-((1-((1-((1-((1-(((_l.LP2state_benchr7_out) * (_l.LP2state_benchn11)) * (1-(_l.IP2sh0)))) * (1-(((_l.LP2state_benchr6_out) * (_l.LP2state_benchn11)) * (_l.IP2sh0))))) * (1-(_l.IP2sh2)))) * (1-((1-((1-(((_l.LP2state_benchr3_out) * (_l.LP2state_benchn11)) * (1-(_l.IP2sh0)))) * (1-(((_l.LP2state_benchr2_out) * (_l.LP2state_benchn11)) * (_l.IP2sh0))))) * (_l.IP2sh2))))) * (_l.IP2controllable_do_shift)))));;\
    }
    );
s.add_edge("Process2", "UpdatedLP2state_benchr7_out", "w", "", "", "release0!", 
    [](syntax::layout_t const & l){\
    multi::layout_t const & _l = CAST(multi::layout_t const &, l);\
...
s.add_edge("Process2", "UpdatedLP2state_benchr7_out", "w", "", "", "release1!", 
    [](syntax::layout_t const & l){\
    multi::layout_t const & _l = CAST(multi::layout_t const &, l);\
