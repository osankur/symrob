...
s.add_edge("Process0", "UpdatedLP0counter2_out", "UpdatedLP0counter3_out", "", "", "", syntax::layout_true,  [](syntax::layout_t  & l){\
    multi::layout_t & _l = CAST(multi::layout_t &, l);\
    _l.LP0counter3_out = ((1-((1-(((((_l.LP0counter1_out) * (_l.LP0n7)) * ((_l.LP0counter0_out) * (_l.LP0n7))) * ((_l.LP0counter2_out) * (_l.LP0n7))) * (1-(_l.IP0stay)))) * (1-((_l.LP0counter3_out) * (_l.LP0n7))))) * (1-((((((_l.LP0counter1_out) * (_l.LP0n7)) * ((_l.LP0counter0_out) * (_l.LP0n7))) * ((_l.LP0counter2_out) * (_l.LP0n7))) * (1-(_l.IP0stay))) * (1-((1-((_l.LP0counter3_out) * (_l.LP0n7))) * (1-(_l.IP0controllable_reset)))))));;\
    }
    );
...
s.add_edge("Process1", "UpdatedLP1counter1_out", "UpdatedLP1counter2_out", "", "", "", syntax::layout_true,  [](syntax::layout_t  & l){\
    multi::layout_t & _l = CAST(multi::layout_t &, l);\
    _l.LP1counter2_out = (1-((1-(((((_l.LP1counter1_out) * (_l.LP1n7)) * ((_l.LP1counter0_out) * (_l.LP1n7))) * (1-(_l.IP1stay))) * (1-((_l.LP1counter2_out) * (_l.LP1n7))))) * (1-((1-((((_l.LP1counter1_out) * (_l.LP1n7)) * ((_l.LP1counter0_out) * (_l.LP1n7))) * (1-(_l.IP1stay)))) * ((_l.LP1counter2_out) * (_l.LP1n7))))));;\
    }
    );
...
s.add_edge("Process1", "UpdatedLP1counter2_out", "UpdatedLP1counter3_out", "", "", "", syntax::layout_true,  [](syntax::layout_t  & l){\
    multi::layout_t & _l = CAST(multi::layout_t &, l);\
    _l.LP1counter3_out = ((1-((1-(((((_l.LP1counter1_out) * (_l.LP1n7)) * ((_l.LP1counter0_out) * (_l.LP1n7))) * ((_l.LP1counter2_out) * (_l.LP1n7))) * (1-(_l.IP1stay)))) * (1-((_l.LP1counter3_out) * (_l.LP1n7))))) * (1-((((((_l.LP1counter1_out) * (_l.LP1n7)) * ((_l.LP1counter0_out) * (_l.LP1n7))) * ((_l.LP1counter2_out) * (_l.LP1n7))) * (1-(_l.IP1stay))) * (1-((1-((_l.LP1counter3_out) * (_l.LP1n7))) * (1-(_l.IP1controllable_reset)))))));;\
    }
    );
...
s.add_edge("Process2", "UpdatedLP2counter1_out", "UpdatedLP2counter2_out", "", "", "", syntax::layout_true,  [](syntax::layout_t  & l){\
    multi::layout_t & _l = CAST(multi::layout_t &, l);\
    _l.LP2counter2_out = (1-((1-(((((_l.LP2counter1_out) * (_l.LP2n7)) * ((_l.LP2counter0_out) * (_l.LP2n7))) * (1-(_l.IP2stay))) * (1-((_l.LP2counter2_out) * (_l.LP2n7))))) * (1-((1-((((_l.LP2counter1_out) * (_l.LP2n7)) * ((_l.LP2counter0_out) * (_l.LP2n7))) * (1-(_l.IP2stay)))) * ((_l.LP2counter2_out) * (_l.LP2n7))))));;\
    }
    );
...
s.add_edge("Process2", "UpdatedLP2counter2_out", "UpdatedLP2counter3_out", "", "", "", syntax::layout_true,  [](syntax::layout_t  & l){\
    multi::layout_t & _l = CAST(multi::layout_t &, l);\
    _l.LP2counter3_out = ((1-((1-(((((_l.LP2counter1_out) * (_l.LP2n7)) * ((_l.LP2counter0_out) * (_l.LP2n7))) * ((_l.LP2counter2_out) * (_l.LP2n7))) * (1-(_l.IP2stay)))) * (1-((_l.LP2counter3_out) * (_l.LP2n7))))) * (1-((((((_l.LP2counter1_out) * (_l.LP2n7)) * ((_l.LP2counter0_out) * (_l.LP2n7))) * ((_l.LP2counter2_out) * (_l.LP2n7))) * (1-(_l.IP2stay))) * (1-((1-((_l.LP2counter3_out) * (_l.LP2n7))) * (1-(_l.IP2controllable_reset)))))));;\
    }
    );
