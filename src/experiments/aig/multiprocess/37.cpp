...
if (_l.LP0benchn13 != LP0benchn13) return false;
...
return true;
	...
	boost::hash_combine(seed,LP0benchn13);
...
s.add_edge("Process0", "JustSetIP0in1", "JustSetIP0controllable_c0", "", "", "", syntax::layout_true,  [](syntax::layout_t  & l){\
    multi::layout_t & _l = CAST(multi::layout_t &, l);\
...
s.add_edge("Process0", "JustSetIP0controllable_c1", "JustSetIP0controllable_s", "", "", "", syntax::layout_true,  [](syntax::layout_t  & l){\
    multi::layout_t & _l = CAST(multi::layout_t &, l);\
...
s.add_location("Process0", "UpdatedLP0benchn13", "", "", syntax::loc_t::COMMITTED);
s.add_edge("Process0", "JustSetIP0controllable_s", "UpdatedLP0benchn13", "", "", "", syntax::layout_true,  [](syntax::layout_t  & l){\
    multi::layout_t & _l = CAST(multi::layout_t &, l);\
    _l.LP0benchn13 = 1;;\
    }
    );
s.add_location("Process0", "UpdatedLP0benchbad_out", "", "", syntax::loc_t::COMMITTED);
s.add_edge("Process0", "UpdatedLP0benchn13", "UpdatedLP0benchbad_out", "", "", "", syntax::layout_true,  [](syntax::layout_t  & l){\
    multi::layout_t & _l = CAST(multi::layout_t &, l);\
    _l.LP0benchbad_out = (1-((1-((_l.LP0benchbad_out) * (_l.LP0benchn13))) * (1-(_l.IP0controllable_s))));;\
    }
    );
...
s.add_edge("Process0", "UpdatedLP0benchbad_out", "UpdatedLP0benchstate0_out", "", "", "", syntax::layout_true,  [](syntax::layout_t  & l){\
    multi::layout_t & _l = CAST(multi::layout_t &, l);\
    _l.LP0benchstate0_out = ((1-((((1-(((_l.IP0controllable_c1) * (_l.IP0controllable_c0)) * (1-(_l.IP0in1)))) * (1-((1-((_l.IP0controllable_c1) * (_l.IP0controllable_c0))) * (_l.IP0in1)))) * (1-(_l.IP0in0))) * (1-((_l.LP0benchstate0_out) * (_l.LP0benchn13))))) * (1-((1-(((1-(((_l.IP0controllable_c1) * (_l.IP0controllable_c0)) * (1-(_l.IP0in1)))) * (1-((1-((_l.IP0controllable_c1) * (_l.IP0controllable_c0))) * (_l.IP0in1)))) * (1-(_l.IP0in0)))) * ((_l.LP0benchstate0_out) * (_l.LP0benchn13)))));;\
    }
    );
...
s.add_edge("Process0", "UpdatedLP0benchstate0_out", "UpdatedLP0benchstate1_out", "", "", "", syntax::layout_true,  [](syntax::layout_t  & l){\
    multi::layout_t & _l = CAST(multi::layout_t &, l);\
    _l.LP0benchstate1_out = (1-((1-((1-((1-(((1-(((_l.IP0controllable_c1) * (_l.IP0controllable_c0)) * (1-(_l.IP0in1)))) * (1-((1-((_l.IP0controllable_c1) * (_l.IP0controllable_c0))) * (_l.IP0in1)))) * (1-(_l.IP0in0)))) * ((_l.LP0benchstate0_out) * (_l.LP0benchn13)))) * ((_l.LP0benchstate1_out) * (_l.LP0benchn13)))) * (1-(((1-(((1-(((_l.IP0controllable_c1) * (_l.IP0controllable_c0)) * (1-(_l.IP0in1)))) * (1-((1-((_l.IP0controllable_c1) * (_l.IP0controllable_c0))) * (_l.IP0in1)))) * (1-(_l.IP0in0)))) * ((_l.LP0benchstate0_out) * (_l.LP0benchn13))) * (1-((_l.LP0benchstate1_out) * (_l.LP0benchn13)))))));;\
    }
    );
s.add_edge("Process0", "UpdatedLP0benchstate1_out", "w", "", "", "release0!", 
    [](syntax::layout_t const & l){\
    multi::layout_t const & _l = CAST(multi::layout_t const &, l);\
...
s.add_edge("Process0", "UpdatedLP0benchstate1_out", "w", "", "", "release1!", 
    [](syntax::layout_t const & l){\
    multi::layout_t const & _l = CAST(multi::layout_t const &, l);\
