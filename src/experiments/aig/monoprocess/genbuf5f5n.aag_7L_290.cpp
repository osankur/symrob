...
s.add_edge("Circuit", "UpdatedLreg_controllable_BtoS_ACK0_out", "dead", "T>2900", "", "", syntax::layout_true);
s.add_edge("Circuit", "UpdatedLreg_controllable_BtoS_ACK0_out", "init", "T<=2900", "T", "", syntax::layout_true);
