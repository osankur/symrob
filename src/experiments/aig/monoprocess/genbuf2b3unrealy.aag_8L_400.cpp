...
s.add_edge("Circuit", "UpdatedLreg_i_nEMPTY_out", "dead", "T>4000", "", "", syntax::layout_true);
s.add_edge("Circuit", "UpdatedLreg_i_nEMPTY_out", "init", "T<=4000", "T", "", syntax::layout_true);
