...
s.add_edge("Circuit", "UpdatedLreg_controllable_hgrant3_out", "dead", "T>2000", "", "", syntax::layout_true);
s.add_edge("Circuit", "UpdatedLreg_controllable_hgrant3_out", "init", "T<=2000", "T", "", syntax::layout_true);
