...
s.add_edge("Circuit", "UpdatedLreg_i_RtoB_ACK1_out", "dead", "T>2900", "", "", syntax::layout_true);
s.add_edge("Circuit", "UpdatedLreg_i_RtoB_ACK1_out", "init", "T<=2900", "T", "", syntax::layout_true);
