...
s.add_edge("Process0", "UpdatedLP0counter1_out", "UpdatedLP0counter2_out", "", "", "", syntax::layout_true,  [](syntax::layout_t  & l){\
    multi::layout_t & _l = CAST(multi::layout_t &, l);\
    _l.LP0counter2_out = ((1-(((((_l.LP0counter1_out) * (_l.LP0n7)) * ((_l.LP0counter0_out) * (_l.LP0n7))) * ((_l.LP0counter2_out) * (_l.LP0n7))) * (1-(_l.IP0stay)))) * (1-((1-(((((_l.LP0counter1_out) * (_l.LP0n7)) * ((_l.LP0counter0_out) * (_l.LP0n7))) * (1-(_l.IP0controllable_reset))) * (1-(_l.IP0stay)))) * (1-((_l.LP0counter2_out) * (_l.LP0n7))))));;\
    }
    );
s.add_edge("Process0", "UpdatedLP0counter2_out", "w", "", "", "release0!", 
    [](syntax::layout_t const & l){\
    multi::layout_t const & _l = CAST(multi::layout_t const &, l);\
...
s.add_edge("Process0", "UpdatedLP0counter2_out", "w", "", "", "release1!", 
    [](syntax::layout_t const & l){\
    multi::layout_t const & _l = CAST(multi::layout_t const &, l);\
