...
bool IP2controllable_s;
bool LP2benchn13;
bool LP2benchbad_out;
bool LP2benchstate0_out;
bool LP2benchstate1_out;
...
LP2benchn13 =0;
LP2benchbad_out =0;
LP2benchstate0_out =0;
LP2benchstate1_out =0;
...
if (_l.IP2in0 != IP2in0) return false;
if (_l.IP2in1 != IP2in1) return false;
if (_l.IP2controllable_c0 != IP2controllable_c0) return false;
if (_l.IP2controllable_c1 != IP2controllable_c1) return false;
if (_l.IP2controllable_s != IP2controllable_s) return false;
if (_l.LP2benchn13 != LP2benchn13) return false;
if (_l.LP2benchbad_out != LP2benchbad_out) return false;
if (_l.LP2benchstate0_out != LP2benchstate0_out) return false;
if (_l.LP2benchstate1_out != LP2benchstate1_out) return false;
...
return true;
	...
	boost::hash_combine(seed,IP2in0);
	boost::hash_combine(seed,IP2in1);
	boost::hash_combine(seed,IP2controllable_c0);
	boost::hash_combine(seed,IP2controllable_c1);
	boost::hash_combine(seed,IP2controllable_s);
	boost::hash_combine(seed,LP2benchn13);
	boost::hash_combine(seed,LP2benchbad_out);
	boost::hash_combine(seed,LP2benchstate0_out);
	boost::hash_combine(seed,LP2benchstate1_out);
...
s.add_edge("Process2", "w", "on0", "", "x2", "go2?", 
    [](syntax::layout_t const & l){\
    multi::layout_t const & _l = CAST(multi::layout_t const &, l);\
    return _l.LP2benchstate0_out == 0;\
    }
    ,  [](syntax::layout_t  & l){\
    multi::layout_t & _l = CAST(multi::layout_t &, l);\
    _l.w2 = 0;\
...
s.add_edge("Process2", "w", "on1", "", "x2", "go2?", 
    [](syntax::layout_t const & l){\
    multi::layout_t const & _l = CAST(multi::layout_t const &, l);\
    return _l.LP2benchstate0_out == 1;\
    }
    ,  [](syntax::layout_t  & l){\
    multi::layout_t & _l = CAST(multi::layout_t &, l);\
    _l.w2 = 0;\
...
s.add_location("Process2", "JustSetIP2in0", "", "", syntax::loc_t::COMMITTED);
s.add_edge("Process2", "up", "JustSetIP2in0", "", "", "", syntax::layout_true,  [](syntax::layout_t  & l){\
    multi::layout_t & _l = CAST(multi::layout_t &, l);\
    _l.IP2in0 = 0;;\
    }
    );
...
s.add_location("Process2", "JustSetIP2in1", "", "", syntax::loc_t::COMMITTED);
s.add_edge("Process2", "JustSetIP2in0", "JustSetIP2in1", "", "", "", syntax::layout_true,  [](syntax::layout_t  & l){\
    multi::layout_t & _l = CAST(multi::layout_t &, l);\
    _l.IP2in1 = 0;;\
    }
    );
...
s.add_edge("Process2", "JustSetIP2in1", "JustSetIP2controllable_c0", "", "", "", syntax::layout_true,  [](syntax::layout_t  & l){\
    multi::layout_t & _l = CAST(multi::layout_t &, l);\
...
s.add_location("Process2", "JustSetIP2controllable_s", "", "", syntax::loc_t::COMMITTED);
s.add_edge("Process2", "JustSetIP2controllable_c1", "JustSetIP2controllable_s", "", "", "", syntax::layout_true,  [](syntax::layout_t  & l){\
    multi::layout_t & _l = CAST(multi::layout_t &, l);\
    _l.IP2controllable_s = 0;;\
    }
    );
s.add_edge("Process2", "JustSetIP2controllable_c1", "JustSetIP2controllable_s", "", "", "", syntax::layout_true,  [](syntax::layout_t  & l){\
    multi::layout_t & _l = CAST(multi::layout_t &, l);\
    _l.IP2controllable_s = 1;;\
    }
    );
s.add_location("Process2", "UpdatedLP2benchn13", "", "", syntax::loc_t::COMMITTED);
s.add_edge("Process2", "JustSetIP2controllable_s", "UpdatedLP2benchn13", "", "", "", syntax::layout_true,  [](syntax::layout_t  & l){\
    multi::layout_t & _l = CAST(multi::layout_t &, l);\
    _l.LP2benchn13 = 1;;\
    }
    );
s.add_location("Process2", "UpdatedLP2benchbad_out", "", "", syntax::loc_t::COMMITTED);
s.add_edge("Process2", "UpdatedLP2benchn13", "UpdatedLP2benchbad_out", "", "", "", syntax::layout_true,  [](syntax::layout_t  & l){\
    multi::layout_t & _l = CAST(multi::layout_t &, l);\
    _l.LP2benchbad_out = (1-((1-((_l.LP2benchbad_out) * (_l.LP2benchn13))) * (1-(_l.IP2controllable_s))));;\
    }
    );
s.add_location("Process2", "UpdatedLP2benchstate0_out", "", "", syntax::loc_t::COMMITTED);
s.add_edge("Process2", "UpdatedLP2benchbad_out", "UpdatedLP2benchstate0_out", "", "", "", syntax::layout_true,  [](syntax::layout_t  & l){\
    multi::layout_t & _l = CAST(multi::layout_t &, l);\
    _l.LP2benchstate0_out = ((1-((((1-(((_l.IP2controllable_c1) * (_l.IP2controllable_c0)) * (1-(_l.IP2in1)))) * (1-((1-((_l.IP2controllable_c1) * (_l.IP2controllable_c0))) * (_l.IP2in1)))) * (1-(_l.IP2in0))) * (1-((_l.LP2benchstate0_out) * (_l.LP2benchn13))))) * (1-((1-(((1-(((_l.IP2controllable_c1) * (_l.IP2controllable_c0)) * (1-(_l.IP2in1)))) * (1-((1-((_l.IP2controllable_c1) * (_l.IP2controllable_c0))) * (_l.IP2in1)))) * (1-(_l.IP2in0)))) * ((_l.LP2benchstate0_out) * (_l.LP2benchn13)))));;\
    }
    );
s.add_location("Process2", "UpdatedLP2benchstate1_out", "", "", syntax::loc_t::COMMITTED);
s.add_edge("Process2", "UpdatedLP2benchstate0_out", "UpdatedLP2benchstate1_out", "", "", "", syntax::layout_true,  [](syntax::layout_t  & l){\
    multi::layout_t & _l = CAST(multi::layout_t &, l);\
    _l.LP2benchstate1_out = (1-((1-((1-((1-(((1-(((_l.IP2controllable_c1) * (_l.IP2controllable_c0)) * (1-(_l.IP2in1)))) * (1-((1-((_l.IP2controllable_c1) * (_l.IP2controllable_c0))) * (_l.IP2in1)))) * (1-(_l.IP2in0)))) * ((_l.LP2benchstate0_out) * (_l.LP2benchn13)))) * ((_l.LP2benchstate1_out) * (_l.LP2benchn13)))) * (1-(((1-(((1-(((_l.IP2controllable_c1) * (_l.IP2controllable_c0)) * (1-(_l.IP2in1)))) * (1-((1-((_l.IP2controllable_c1) * (_l.IP2controllable_c0))) * (_l.IP2in1)))) * (1-(_l.IP2in0)))) * ((_l.LP2benchstate0_out) * (_l.LP2benchn13))) * (1-((_l.LP2benchstate1_out) * (_l.LP2benchn13)))))));;\
    }
    );
s.add_edge("Process2", "UpdatedLP2benchstate1_out", "w", "", "", "release0!", 
    [](syntax::layout_t const & l){\
    multi::layout_t const & _l = CAST(multi::layout_t const &, l);\
...
s.add_edge("Process2", "UpdatedLP2benchstate1_out", "w", "", "", "release1!", 
    [](syntax::layout_t const & l){\
    multi::layout_t const & _l = CAST(multi::layout_t const &, l);\
