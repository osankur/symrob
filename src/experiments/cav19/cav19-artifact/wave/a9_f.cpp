...
s.add_edge("Node2", "down", "up", "x2>=200 && x2<=600", "", "", 
                    [](syntax::layout_t const & l){
                       wave::layout_t const & _l = CAST(wave::layout_t const &, l);
                       return _l.out16 < 2 && _l.out17 < 2 && _l.out18 < 2 && _l.out19 < 2 && _l.out1 < 2 && (_l.out16+(_l.out17+(_l.out18+(_l.out19+(_l.out1))))) >= 10;
                    }
                    , 
                    [](syntax::layout_t  & l){
                       wave::layout_t & _l = CAST(wave::layout_t &, l);
...
s.add_edge("Node2", "down", "down", "x2 == 200", "x2", "", 
                    [](syntax::layout_t const & l){
                       wave::layout_t const & _l = CAST(wave::layout_t const &, l);
                       return (_l.out16 != 2 && (_l.out17 != 2 && (_l.out18 != 2 && (_l.out19 != 2 && (_l.out1 != 2))))) == 0;
                    }
                    );
