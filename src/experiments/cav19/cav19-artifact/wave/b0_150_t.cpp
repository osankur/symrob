...
s.add_edge("Node0", "down", "up", "x0>=100 && x0 <= 300 && t <= 150", "", "",
                    [](syntax::layout_t const & l){
                       wave::layout_t const & _l = CAST(wave::layout_t const &, l);
                       return _l.out5 < 2 && _l.out4 < 2 && _l.out5 == 1 && _l.out4 == 1;
                    }
                    ,
                    [](syntax::layout_t  & l){
...
s.add_edge("Node0", "down", "down", "t>150", "", "", syntax::layout_true, [](syntax::layout_t  & l){wave::layout_t & _l = CAST(wave::layout_t &, l);
_l.out0 = 2;
...
s.add_edge("Node0", "down", "up", "x0>=100 && x0<=300", "", "", 
                    [](syntax::layout_t const & l){
                       wave::layout_t const & _l = CAST(wave::layout_t const &, l);
                       return _l.out5 < 2 && _l.out4 < 2 && (_l.out5 == 1 && _l.out4 == 1)==0;
                    }
                    , 
                    [](syntax::layout_t  & l){
                       wave::layout_t & _l = CAST(wave::layout_t &, l);
...
s.add_edge("Node1", "down", "up", "x1>=50 && x1<=400", "", "", 
                    [](syntax::layout_t const & l){
                       wave::layout_t const & _l = CAST(wave::layout_t const &, l);
                       return _l.out4 < 2 && _l.out5 < 2 && _l.out6 < 2 && _l.out7 < 2 && (_l.out4+(_l.out5+(_l.out6+(_l.out7)))) >= 3;
                    }
                    , 
                    [](syntax::layout_t  & l){
                       wave::layout_t & _l = CAST(wave::layout_t &, l);
...
s.add_edge("Node1", "down", "down", "x1 == 50", "x1", "", 
                    [](syntax::layout_t const & l){
                       wave::layout_t const & _l = CAST(wave::layout_t const &, l);
                       return (_l.out4 != 2 && (_l.out5 != 2 && (_l.out6 != 2 && (_l.out7 != 2)))) == 0;
                    }
                    );
...
s.add_edge("Node2", "down", "up", "x2>=200 && x2<=600", "", "", 
                    [](syntax::layout_t const & l){
                       wave::layout_t const & _l = CAST(wave::layout_t const &, l);
                       return _l.out1 < 2 && _l.out4 < 2 && _l.out5 < 2 && _l.out6 < 2 && (_l.out1+(_l.out4+(_l.out5+(_l.out6)))) >= 2;
                    }
                    , 
                    [](syntax::layout_t  & l){
                       wave::layout_t & _l = CAST(wave::layout_t &, l);
...
s.add_edge("Node2", "down", "down", "x2 == 200", "x2", "", 
                    [](syntax::layout_t const & l){
                       wave::layout_t const & _l = CAST(wave::layout_t const &, l);
                       return (_l.out1 != 2 && (_l.out4 != 2 && (_l.out5 != 2 && (_l.out6 != 2)))) == 0;
                    }
                    );
...
s.add_edge("input", "input_init", "in4","", "","",syntax::layout_true,
            [](syntax::layout_t  & l){
            wave::layout_t & _l = CAST(wave::layout_t &, l);
            _l.out4 = 0;
            }
...
s.add_edge("input", "in7", "input_end");
