...
s.add_edge("Node0", "down", "up", "x0>=100 && x0 <= 300 && t <= 300", "", "",
...
s.add_edge("Node0", "down", "down", "t>300", "", "", syntax::layout_true, [](syntax::layout_t  & l){wave::layout_t & _l = CAST(wave::layout_t &, l);
_l.out0 = 2;
