...
s.add_edge("Node1", "down", "up", "x1>=50 && x1<=400", "", "", 
                    [](syntax::layout_t const & l){
                       wave::layout_t const & _l = CAST(wave::layout_t const &, l);
                       return _l.out6 < 2 && _l.out7 < 2 && _l.out8 < 2 && _l.out9 < 2 && (_l.out6+(_l.out7+(_l.out8+(_l.out9)))) >= 3;
                    }
                    , 
                    [](syntax::layout_t  & l){
                       wave::layout_t & _l = CAST(wave::layout_t &, l);
...
s.add_edge("Node1", "down", "down", "x1 == 50", "x1", "", 
                    [](syntax::layout_t const & l){
                       wave::layout_t const & _l = CAST(wave::layout_t const &, l);
                       return (_l.out6 != 2 && (_l.out7 != 2 && (_l.out8 != 2 && (_l.out9 != 2)))) == 0;
                    }
                    );
...
s.add_edge("Node2", "down", "up", "x2>=200 && x2<=600", "", "", 
                    [](syntax::layout_t const & l){
                       wave::layout_t const & _l = CAST(wave::layout_t const &, l);
                       return _l.out1 < 2 && _l.out6 < 2 && _l.out7 < 2 && _l.out8 < 2 && (_l.out1+(_l.out6+(_l.out7+(_l.out8)))) >= 2;
                    }
                    , 
                    [](syntax::layout_t  & l){
                       wave::layout_t & _l = CAST(wave::layout_t &, l);
...
s.add_edge("Node2", "down", "down", "x2 == 200", "x2", "", 
                    [](syntax::layout_t const & l){
                       wave::layout_t const & _l = CAST(wave::layout_t const &, l);
                       return (_l.out1 != 2 && (_l.out6 != 2 && (_l.out7 != 2 && (_l.out8 != 2)))) == 0;
                    }
                    );
...
s.add_edge("Node4", "down", "up", "x4>=250 && x4<=0", "", "", 
                    [](syntax::layout_t const & l){
                       wave::layout_t const & _l = CAST(wave::layout_t const &, l);
                       return _l.out7 < 2 && _l.out3 < 2 && _l.out7 == 1 && _l.out3 == 1;
                    }
                    , 
                    [](syntax::layout_t  & l){
                       wave::layout_t & _l = CAST(wave::layout_t &, l);
...
s.add_edge("Node4", "down", "up", "x4>=250 && x4<=0", "", "", 
                    [](syntax::layout_t const & l){
                       wave::layout_t const & _l = CAST(wave::layout_t const &, l);
                       return _l.out7 < 2 && _l.out3 < 2 && (_l.out7 == 1 && _l.out3 == 1)==0;
                    }
                    , 
                    [](syntax::layout_t  & l){
                       wave::layout_t & _l = CAST(wave::layout_t &, l);
