...
s.add_edge("Circuit", "UpdatedLsys_fair0done_out", "dead", "T>2500", "", "", syntax::layout_true);
s.add_edge("Circuit", "UpdatedLsys_fair0done_out", "init", "T<=2500", "T", "", syntax::layout_true);
