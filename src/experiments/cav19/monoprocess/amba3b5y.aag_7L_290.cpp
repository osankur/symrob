...
s.add_edge("Circuit", "UpdatedLreg_controllable_locked_out", "dead", "T>2900", "", "", syntax::layout_true);
s.add_edge("Circuit", "UpdatedLreg_controllable_locked_out", "init", "T<=2900", "T", "", syntax::layout_true);
