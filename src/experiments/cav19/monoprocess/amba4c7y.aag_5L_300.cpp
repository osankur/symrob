...
s.add_edge("Circuit", "UpdatedLnext_env_fair_out", "dead", "T>3000", "", "", syntax::layout_true);
s.add_edge("Circuit", "UpdatedLnext_env_fair_out", "init", "T<=3000", "T", "", syntax::layout_true);
