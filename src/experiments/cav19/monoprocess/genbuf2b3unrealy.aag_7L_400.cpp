...
s.add_edge("Circuit", "UpdatedLenv_fair1done_out", "dead", "T>4000", "", "", syntax::layout_true);
s.add_edge("Circuit", "UpdatedLenv_fair1done_out", "init", "T<=4000", "T", "", syntax::layout_true);
