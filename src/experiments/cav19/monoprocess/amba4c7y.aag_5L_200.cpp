...
s.add_edge("Circuit", "UpdatedLnext_env_fair_out", "dead", "T>2000", "", "", syntax::layout_true);
s.add_edge("Circuit", "UpdatedLnext_env_fair_out", "init", "T<=2000", "T", "", syntax::layout_true);
