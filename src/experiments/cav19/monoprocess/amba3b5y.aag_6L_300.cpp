...
s.add_edge("Circuit", "UpdatedLenv_fair1done_out", "dead", "T>3000", "", "", syntax::layout_true);
s.add_edge("Circuit", "UpdatedLenv_fair1done_out", "init", "T<=3000", "T", "", syntax::layout_true);
